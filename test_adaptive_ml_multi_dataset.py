"""
Adaptive ML Trailing Stop Strategy Multi-Dataset Backtest
...
def run_multi_dataset_backtest():
    ...
    print("=" * 80)
    print("ADAPTIVE ML TRAILING STOP STRATEGY - MULTI-DATASET BACKTEST")
    print("=" * 80)
    print(f"\nTesting {len(datasets)} different symbol/timeframe combinations")
    print(f"Strategy: Adaptive ML Trailing Stop (KAMA + ATR, 5% SL)")
    print("\n" + "=" * 80 + "\n")
    ...
    if results:
        ...
        # Save results to CSV
        csv_path = '/Users/mr.joo/Desktop/전략연구소/adaptive_ml_results.csv'
